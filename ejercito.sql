...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2023 a las 01:42:14
...
INSERT INTO `servicios` (`códigoServicio`, `descripción`, `fecha_hora_servicio`, `codigoSoldado`) VALUES
(1, 'Pio', '2023-10-24 02:09:17', 1);
...
INSERT INTO `soldados` (`codigoSoldado`, `nombre`, `apellido`, `graduacion`, `numeroCompañia`, `codigoCuerpo`, `codigoCuartel`) VALUES
(1, 'Juan', 'Pio', NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `servicios`
  MODIFY `códigoServicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `soldados`
  MODIFY `codigoSoldado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
